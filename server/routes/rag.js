...
router.post('/chat', async (req, res) => {
  const { message, user_id, rag = false, history = [], ai_model, embed_model, live_memory_context, claude_memory_context } = req.body
